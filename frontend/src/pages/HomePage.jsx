...
// Converts any CSS color string to rgba with a given opacity
...
const cardShadow = (color) => {
  const c = toRgba(color, 0.38);
  return [
    `inset  90px 0px 70px -30px ${c}`,
    `inset -90px 0px 70px -30px ${c}`,
    `inset 0px  90px 70px -30px ${c}`,
    `inset 0px -90px 70px -30px ${c}`,
  ].join(', ');
};
...
const HomePage = () => {
  ...
  return (
    <div className="flex w-full h-screen bg-[#0e0e10] overflow-hidden">
      ...
      <div
        className="w-[53%] h-screen overflow-visible z-20 bg-[#0e0e10] relative"
        onWheel={handleWheel}
      >
        <motion.div
        ...
        >
          ...
          <div className="h-screen w-full flex flex-col relative pb-16">
            ...
            >
              {/* Header + text both anchored at the bottom */}
              <div
                id="wiki-scroll-area"
                className="flex-1 overflow-y-auto px-16 pb-16 pt-8 relative z-10 flex flex-col items-center justify-center gap-5"
              ...
              >
                ...
                <motion.p 
                  className="text-lg leading-relaxed text-center font-medium opacity-90 italic max-w-xl mx-auto"
                  animate={{ 
          ...
          >
            ...
            >
              <div className="flex flex-col items-center mb-12 text-center">
                <div className="h-px w-16 mb-6 opacity-30" style={{ backgroundColor: themeConfig.mainTextColor || 'white' }} />
